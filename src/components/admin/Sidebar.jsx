...
export const Sidebar = () => {
    ...
    return (
        <aside id="sidebar-container" className="w-80 bg-[#e0e5ec] flex flex-col border-r border-white/20 shadow-[9px_0_16px_rgba(163,177,198,0.4)] z-40">
            <div className="p-6">
            ...
            <div id="sidebar-library-list" className="flex-1 overflow-y-auto px-4 space-y-3 pb-4">
                {books.map((book) => (
                    <div
                        key={book.id}
            ...
            <div className="p-4 border-t border-white/20 space-y-4">
                <button
                    ...
                    disabled={isDemoMode}
                    className={`w-full py-2 text-xs transition-colors ${isDemoMode ? "text-gray-400 cursor-not-allowed" : "text-red-400 hover:text-red-600"}`}
                >
                    Clean Empty Issues
                </button>
            </div>
