...
import { NeomorphicLogo } from "../components/NeomorphicLogo";
...
export const LandingPage = () => {
    ...
    if (isLoading) {
        return <FullPageLoader logoUrl={settings.school_logo_url} />;
    }
                ...
                <div className="neo-card max-w-7xl mx-auto px-4 md:px-6 py-3 flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3 cursor-pointer group" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
                        <NeomorphicLogo
                            ...
                            size="sm"
                        />
                        <h1 className="text-base md:text-lg font-bold tracking-tight text-gray-700 group-hover:text-blue-600 transition-colors">
                    ...
                    <div className="hidden md:flex items-center gap-6">
                        <button onClick={() => scrollToSection('hero')} className="text-sm font-semibold text-gray-600 hover:text-blue-500 transition-colors hover:scale-105 transform duration-200">{t('nav.home')}</button>
                        <button onClick={() => scrollToSection('about')} className="text-sm font-semibold text-gray-600 hover:text-blue-500 transition-colors hover:scale-105 transform duration-200">{t('nav.about')}</button>
                        <button onClick={() => scrollToSection('library')} className="text-sm font-semibold text-gray-600 hover:text-blue-500 transition-colors hover:scale-105 transform duration-200">{t('nav.library')}</button>
                        <button onClick={() => scrollToSection('suggestions')} className="text-sm font-semibold text-gray-600 hover:text-blue-500 transition-colors hover:scale-105 transform duration-200">{t('nav.feedback')}</button>
                    </div>
                    ...
                    <div className="md:hidden">
                        ...
                        >
                            <MobileMenuItem onClick={() => { scrollToSection('hero'); setMobileMenuOpen(false); }}>
                                🏠 Home
                            </MobileMenuItem>
                            <MobileMenuItem onClick={() => { scrollToSection('about'); setMobileMenuOpen(false); }}>
                                ℹ️ About
                            </MobileMenuItem>
                            <MobileMenuItem onClick={() => { scrollToSection('library'); setMobileMenuOpen(false); }}>
                                📚 Library
                            </MobileMenuItem>
                            <MobileMenuItem onClick={() => { scrollToSection('suggestions'); setMobileMenuOpen(false); }}>
                                💬 Feedback
                            </MobileMenuItem>
                            <div className="pt-2 border-t border-gray-200/50">
                                <input
                                    ...
                                    value={searchQuery}
                                    onChange={(e) => setSearchQuery(e.target.value)}
                                    className="neo-input py-2 text-sm w-full mb-2"
                                />
                                <Link
                                    to="/admin"
                                    className="neo-btn text-xs px-4 py-2 text-blue-600 w-full text-center block"
            ...
            <main className="flex-1 max-w-7xl mx-auto w-full px-4 space-y-24 py-12">
                    ...
                    <ScrollReveal animation="slide-right" duration={800}>
                        <div className="w-full md:w-1/2 space-y-8 text-center md:text-left order-2 md:order-1">
                            <ScrollReveal animation="pop" delay={200}>
                                <div className="inline-block px-4 py-1 rounded-full bg-[#e0e5ec] shadow-[inset_3px_3px_6px_rgba(163,177,198,0.4),inset_-3px_-3px_6px_rgba(255,255,255,0.7)]">
                                    <span className="text-sm font-bold text-blue-500 tracking-wider uppercase">{t('landing.welcome')}</span>
                                </div>
                            </ScrollReveal>
                            <ScrollReveal animation="pop" delay={400}>
                                <h2 className="text-5xl md:text-7xl font-bold text-gray-700 tracking-tighter leading-tight">
                                    <Trans i18nKey="landing.hero_title" components={{ 1: <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500" /> }} />
                                </h2>
                            </ScrollReveal>
                            <ScrollReveal animation="pop" delay={600}>
                                <p className="text-lg text-gray-500 leading-relaxed max-w-xl mx-auto md:mx-0">
                                    {settings.school_description || t('landing.hero_desc')}
                                </p>
                            </ScrollReveal>
                        ...
                        <ScrollReveal animation="extrude" delay={300} duration={1000}>
                            {latestBook ? (
                                ...
                                <div className="w-64 h-80 neo-card flex items-center justify-center">
                                    <p className="text-gray-400">{t('landing.no_issues')}</p>
                                </div>
                            )}
                        </ScrollReveal>
                    </div>
                            ...
                            <div className="grid md:grid-cols-3 gap-12">
                                <ScrollReveal animation="pop" delay={0}>
                                    <div className="text-center space-y-4 p-4 rounded-2xl transition-all duration-300 hover:bg-[#e0e5ec] hover:shadow-[inset_5px_5px_10px_rgba(163,177,198,0.6),inset_-5px_-5px_10px_rgba(255,255,255,0.8)] group cursor-default">
                                        ...
                                        <h3 className="text-xl font-bold text-gray-700">{t('landing.innovation_title')}</h3>
                                        <p className="text-gray-500 text-sm leading-relaxed">
                                            {t('landing.innovation_desc')}
                                        </p>
                                    </div>
                                </ScrollReveal>
                                <ScrollReveal animation="pop" delay={100}>
                                    <div className="text-center space-y-4 p-4 rounded-2xl transition-all duration-300 hover:bg-[#e0e5ec] hover:shadow-[inset_5px_5px_10px_rgba(163,177,198,0.6),inset_-5px_-5px_10px_rgba(255,255,255,0.8)] group cursor-default">
                                        ...
                                        <h3 className="text-xl font-bold text-gray-700">{t('landing.creativity_title')}</h3>
                                        <p className="text-gray-500 text-sm leading-relaxed">
                                            {t('landing.creativity_desc')}
                                        </p>
                                    </div>
                                </ScrollReveal>
                                <ScrollReveal animation="pop" delay={200}>
                                    <div className="text-center space-y-4 p-4 rounded-2xl transition-all duration-300 hover:bg-[#e0e5ec] hover:shadow-[inset_5px_5px_10px_rgba(163,177,198,0.6),inset_-5px_-5px_10px_rgba(255,255,255,0.8)] group cursor-default">
                                        ...
                                        <h3 className="text-xl font-bold text-gray-700">{t('landing.community_title')}</h3>
                                        <p className="text-gray-500 text-sm leading-relaxed">
                ...
                <section id="library" className="space-y-10">
                    <div className="flex flex-col md:flex-row items-end justify-between gap-4 px-2">
                        <div>
                            <h3 className="text-3xl font-bold text-gray-700 mb-2">{t('landing.archive_title')}</h3>
                            <p className="text-gray-500">{t('landing.archive_subtitle')}</p>
                        </div>
                        <div className="text-sm text-gray-400 font-medium px-4 py-2 rounded-full bg-[#e0e5ec] shadow-[inset_2px_2px_5px_rgba(163,177,198,0.4),inset_-2px_-2px_5px_rgba(255,255,255,0.7)]">
                            {t('landing.issues_found', { count: filteredBooks.length })}
                        </div>
                    </div>

                    {filteredBooks.length === 0 ? (
                        <div className="neo-card p-16 text-center">
                            <p className="text-xl text-gray-400">{t('landing.no_results')}</p>
                            <button onClick={() => setSearchQuery("")} className="mt-4 text-blue-500 hover:underline">{t('landing.clear_search')}</button>
                        </div>
                    ) : (
                                            ...
                                            <div className="flex-1 flex flex-col">
                                                ...
                                                <div className="pt-4 border-t border-gray-200/50">
                                                    ...
                                                    {book.likes !== undefined && book.likes > 0 && (
                                                        <div className="flex items-center gap-1.5 text-pink-500 mb-3">
                                                            ...
                                                            <span className="text-xs font-semibold">
                                                                {book.likes} {book.likes === 1 ? t('common.like') : t('common.likes')}
                                                            </span>
                                                        </div>
                                                    )}
                                                    ...
                                                    <div className="flex items-center justify-between">
                                                        <span className="text-xs font-semibold text-gray-400">{t('common.read_now')}</span>
                    ...
                    <div className="neo-card p-8 md:p-12 relative overflow-hidden transition-all duration-300 hover:shadow-[12px_12px_24px_rgba(163,177,198,0.7),-12px_-12px_24px_rgba(255,255,255,0.9)]">
                        ...
                        <div className="relative z-10">
                            <div className="text-center mb-10">
                                <h3 className="text-2xl font-bold text-gray-700 mb-3">{t('landing.suggestions_title')}</h3>
                                <p className="text-gray-500">
                                    {t('landing.suggestions_desc')}
                                </p>
                            </div>
                            ...
                            <form onSubmit={handleSuggestionSubmit} className="space-y-6">
                                <div>
                                    <textarea
                                        ...
                                        placeholder={t('landing.suggestion_placeholder')}
                                        rows={5}
                                ...
                                <div className="flex justify-center">
                                    ...
                                    >
                                        {suggestionStatus === "submitting" ? t('landing.sending') : t('landing.submit_suggestion')}
                                    </button>
                                </div>
            ...
            <footer className="mt-20 py-12 bg-[#e0e5ec] border-t border-white/50">
                <div className="max-w-7xl mx-auto px-4 text-center space-y-6">
                    ...
                    <div className="flex justify-center gap-8 text-sm text-gray-500">
                        <button onClick={() => scrollToSection('hero')} className="hover:text-blue-500 transition-colors hover:scale-105 transform">{t('nav.home')}</button>
                        <button onClick={() => scrollToSection('library')} className="hover:text-blue-500 transition-colors hover:scale-105 transform">{t('nav.library')}</button>
                        <button onClick={() => scrollToSection('suggestions')} className="hover:text-blue-500 transition-colors hover:scale-105 transform">{t('nav.feedback')}</button>
                        <Link to="/admin" className="hover:text-blue-500 transition-colors hover:scale-105 transform">{t('nav.admin_login')}</Link>
                    </div>
                    <p className="text-xs text-gray-400">
                        © {new Date().getFullYear()} {settings.school_name}. {t('landing.footer_powered')}
                    </p>
                </div>
            </footer>
        </div >
